...
!  end if
  ...
  write(15,"(A)") "age, M, A, Aindex, AIME, AIMEindex, Wage, Windex, Aopt, Copt, Hopt, Bopt, nextAIMEopt, value"
  do Ai = 1, Anum
     do AIMEi = 1, AIMEnum

        call optmum3_gsearch(95_8, Astate(Ai), AIMEstate(AIMEi), Astate, AIMEstate, 0.0_8, Copt, Aopt, Iopt, pbopt, ssopt, valopt)
        do Bi = 1, 2
        ...
        write(15,'(i2, a, f4.2, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, f10.2, a, f10.2, a, i2, a, f10.2, a, f18.10)') &
             95, ',', 0.0_8, ',', Astate(Ai), ',', Ai, ',', AIMEstate(AIMEi), ',', AIMEi, ',',  0.0_8, ',', 1_8, ',', Aopt, ',', Copt, ',', 0.0_8, ',', 1_8, ',', AIMEstate(AIMEi), ',', valopt

        call optmum3_gsearch(95_8, Astate(Ai), AIMEstate(AIMEi), Astate, AIMEstate, 1.0_8, Copt, Aopt, Iopt, pbopt, ssopt, valopt)
        do Bi = 1, 2
        ...
        write(15,'(i2, a, f4.2, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, f10.2, a, f10.2, a, i2, a, f10.2, a, f18.10)') &
             95, ',', 1.0_8, ',', Astate(Ai), ',', Ai, ',', AIMEstate(AIMEi), ',', AIMEi, ',',  0.0_8, ',', 1_8, ',', Aopt, ',', Copt, ',', 0.0_8, ',', 1_8, ',', AIMEstate(AIMEi), ',', valopt
...
do age = dieage-1, etstage, -1 !age 94-70
   ...
   do Ai = 1, Anum
      do AIMEi = 1, AIMEnum
         call optmum2(age, Astate(Ai), AIMEstate(AIMEi), 0.0_8, Vgood, Vbad, Astate, Wstate, AIMEstate, mortality_good, mortality_bad, good_to_bad, bad_to_bad, Copt, Aopt, Iopt, pbopt, ssopt, valopt)
         do Bi =1, 2
         ...
         write(15,'(i2, a, f4.2, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, f10.2, a, f10.2, a, i2, a, f10.2, a, f18.10)')&
              age, ',', 0.0_8, ',', Astate(Ai), ',', Ai, ',', AIMEstate(AIMEi), ',', AIMEi, ',',  0.0_8, ',', 1_8, ',', Aopt, ',', Copt, ',', 0.0_8, ',', 1_8, ',', AIMEstate(AIMEi), ',', valopt

         call optmum2(age, Astate(Ai), AIMEstate(AIMEi), 1.0_8, Vgood, Vbad, Astate, Wstate, AIMEstate, mortality_good, mortality_bad, good_to_bad, bad_to_bad, Copt, Aopt, Iopt, pbopt, ssopt, valopt)
         do Bi =1, 2
         ...
         write(15,'(i2, a, f4.2, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, f10.2, a, f10.2, a, i2, a, f10.2, a, f18.10)')&
              age, ',', 1.0_8, ',', Astate(Ai), ',', Ai, ',', AIMEstate(AIMEi), ',', AIMEi, ',',  0.0_8, ',', 1_8, ',', Aopt, ',', Copt, ',', 0.0_8, ',', 1_8, ',', AIMEstate(AIMEi), ',', valopt
...
!      end if
 ...
 !              end if
             call optmum1(age, Astate(Ai), AIMEstate(AIMEi), Bi, Wstate(Wi), 0.0_8, Vgood, Vbad, Astate, AIMEstate, Wstate, Hstate, mortality_good, mortality_bad, good_to_bad, bad_to_bad, &
               ...
               write(15,'(i2, a, f4.2, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, f10.2, a, f10.2, a, i3, a, f10.2, a, f18.10)')&
                    age, ',', 0.0_8, ',', Astate(Ai), ',', Ai, ',', AIMEstate(AIMEi), ',', AIMEi, ',', Wstate(Wi), ',', Wi, ',', Aopt, ',', Copt, ',', Hopt, ',', Bopt, ',', AIMEopt, ',', valopt
               ...
               write(15,'(i2, a, f4.2, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, f10.2, a, f10.2, a, i3, a, f10.2, a, f18.10)')&
                    age, ',', 1.0_8, ',', Astate(Ai), ',', Ai, ',', AIMEstate(AIMEi), ',', AIMEi, ',', Wstate(Wi), ',', Wi, ',', Aopt, ',', Copt, ',', Hopt, ',', Bopt, ',', AIMEopt, ',', valopt
   ...
   do Wi = 1, Wnum
      do Ai = 1, Anum
         do AIMEi = 1, AIMEnum
            ...
            write(15,'(i2, a, f4.2, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, f10.2, a, f10.2, a, i3, a, f10.2, a, f18.10)') &
                 age, ',', 0.0_8, ',', Astate(Ai), ',', Ai, ',', AIMEstate(AIMEi), ',', AIMEi, ',', Wstate(Wi), ',', Wi, ',', Aopt, ',', Copt, ',', Hopt, ',', 0_8, ',', AIMEopt, ',', valopt
            ...
            write(15,'(i2, a, f4.2, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, i3, a, f10.2, a, f10.2, a, f10.2, a, i3, a, f10.2, a, f18.10)') &
                 age, ',', 1.0_8, ',', Astate(Ai), ',', Ai, ',', AIMEstate(AIMEi), ',', AIMEi, ',', Wstate(Wi), ',', Wi, ',', Aopt, ',', Copt, ',', Hopt, ',', 0_8, ',', AIMEopt, ',', valopt
         end do !AIME loop
      end do ! A loop
   end do !W loop
end do !age loop
