...
contains
 ...
 subroutine profwage(ulogwage, hlogwage, hhgr, hugr, uhgr, uugr)
  ...
  if (tiedwage==0_8) then
     open(unit = 75, iostat = ios, file ='profwage_log_u_adj_simout2.csv', action = 'read', form = 'formatted', status ='old')
     if (ios /= 0) then
     ...
     open(unit = 76, iostat = ios, file ='profwage_log_h_adj_simout2.csv', action = 'read', form = 'formatted', status ='old')
     if (ios /= 0) then
        write(*,*) 'Failed to open!'
        stop
     end if
     ...
     open(unit = 71, iostat = ios, file = 'wage_growth_uugr_adj_simout2.csv', action = 'read', form = 'formatted', status = 'old')
     if (ios /= 0) then
        write(*,*) 'Failed to open!'
        stop
     end if
     ...
     open(unit = 72, iostat = ios, file = 'wage_growth_uhgr_adj_simout2.csv', action = 'read', form = 'formatted', status = 'old')
     if (ios /= 0) then
        write(*,*) 'Failed to open!'
        stop
     end if
     ...
     open(unit = 73, iostat = ios, file = 'wage_growth_hugr_adj_simout2.csv', action = 'read', form = 'formatted', &
          & status = 'old')
     if (ios /= 0) then
        write(*,*) 'Failed to open!'
        stop
     ...
     close(73)
!_adj_simout2
     open(unit = 74, iostat = ios, file = 'wage_growth_hhgr_adj_simout2.csv', action = 'read', form = 'formatted', &
          & status = 'old')
     if (ios /= 0) then
        write(*,*) 'Failed to open!'
        stop
