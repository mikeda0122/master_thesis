...
contains
  ...
  subroutine optmum2(age, A, AIME, M, Vgood, Vbad, Astate, Wstate, AIMEstate, Cstate, mortality_good, mortality_bad, good_to_bad, bad_to_bad, Copt, Aopt, Iopt, pbopt, ssopt, valopt)
    ...
    real(8), intent(in) :: Astate(:), Wstate(:), AIMEstate(:), Cstate(:)
