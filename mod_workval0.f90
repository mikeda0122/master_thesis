...
contains
  ...
  subroutine workval0(age, A, AIME, W, Cinit, M, Vgood, Vbad, Astate, AIMEstate, Wstate,&
    ...
    if (fixC==0_8) then
       ...
       do i = 1, Cnum2
         ...
         call computeval0(age, A, W, M, temp_Cinit, H, particip, currentB, nextperiodAIME, income, ss,&
              ...
              ageshift, gvec, mortality_good, mortality_bad, good_to_bad, bad_to_bad, Vgood, Vbad, &
              wtpogood, wtpobad, nextperiodassets, utils, Evtpo, val)
       call computeval0(age, A, W, M, p_Cstate(2), H, particip, currentB, nextperiodAIME, income, ss,&
            laborincome, PIA, Astate, Wstate, AIMEstate, hlogwage, ulogwage, hhgr, hugr, uhgr, uugr, &
            ageshift, gvec, mortality_good, mortality_bad, good_to_bad, bad_to_bad, Vgood, Vbad, &
            wtpogood, wtpobad, nextperiodassets, utils, Evtpo, valp)
       ...
       call computeval0(age, A, W, M, m_Cstate(2), H, particip, currentB, nextperiodAIME, income, ss,&
            laborincome, PIA, Astate, Wstate, AIMEstate, hlogwage, ulogwage, hhgr, hugr, uhgr, uugr, &
            ageshift, gvec, mortality_good, mortality_bad, good_to_bad, bad_to_bad, Vgood, Vbad, &
            wtpogood, wtpobad, nextperiodassets, utils, Evtpo, valm)
       ...
       if (Cinit<inCstate(2)) then
          ...
          & mortality_good, mortality_bad, good_to_bad, bad_to_bad, Vgood, Vbad, wtpogood, wtpobad, nextperiodassets, &
          utils, Evtpo, valp)
    ...
    do Ci = 1, Clen
       ...
       & gvec, mortality_good, mortality_bad, good_to_bad, bad_to_bad, Vgood, Vbad, wtpogood, wtpobad,&
