...
contains
  ...
  subroutine decrule(Astate, Wstate, AIMEstate, mortality_good, mortality_bad, good_to_bad, bad_to_bad, hlogwage, ulogwage, &
       hhgr, hugr, uhgr, uugr, gvec, ageshift, &
    ...
    do Ai = 1, Asnum
       do AIMEi = 1, AIMEnum
          ...
          call optmum3_gsearch(95_8, Astate(Ai), AIMEstate(AIMEi), Astate, AIMEstate, Cstate, 1.0_8, Copt, &
          & Aopt, Iopt, pbopt, ssopt, valopt)
          do Bi = 1, 2
