...
contains
  ...
  subroutine workval1(age, A, AIME, W, Cinit, M, Vgood, Vbad, Astate, AIMEstate, &
    & Wstate, inCstate, Hstate, mortality_good, mortality_bad, good_to_bad, &
    & bad_to_bad, hlogwage, ulogwage, hhgr, hugr, uhgr, uugr, gvec, ageshift, H,&
    ...
    if (fixC==0_8) then
       ...
       & gvec, mortality_good, mortality_bad, good_to_bad, bad_to_bad, eretadj, bigcred, cumeretadj, litcred, &
