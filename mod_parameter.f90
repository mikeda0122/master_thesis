module mod_parameter
    ...
    ! pension
    real(8), parameter :: pb0 = (-66.50d0)*0.68d0
    real(8), parameter :: pb1 = (0.31460d0)*0.68d0
    real(8), parameter :: pb2 = (2.8240d0)*0.68d0
    real(8), parameter :: pbbk = 5000.0d0
    integer(8), parameter :: penbensstart = 62_8!55_8

    real(8), parameter :: pax = 0.63d0
    real(8), parameter :: pa0 = 0.0334*0.40d0
    real(8), parameter :: pa1 = .0000028*0.40d0
    real(8), parameter :: pa2 = .0988*0.40d0
    real(8), parameter :: pabk = 23000.0d0
